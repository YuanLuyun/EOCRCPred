...
features_to_keep = [
    ...
    'Primary_site_Rectum',
    'Primary_site_Descending_colon',
    'Primary_site_Transverse_colon',
    'Resection_type_Hemicolectomy_or_greater',
    'Resection_type_Total_colectomy',
    'Resection_type_Colectomy_plus_removal_of_other_organs',
    'Surg.Rad.Seq_Postoperative',
    'Surg.Rad.Seq_Preoperative',
    'Surg.Rad.Seq_Preoperative+Postoperative',
    'Surg.Rad.Seq_Sequence_unknown',
    'Chemotherapy_Yes',
