...
features_to_keep = [
    ...
    'Race_Black',
    'Race_Other',
    'Primary_site_Sigmoid colon',
    'Primary_site_Rectum',
    'Primary_site_Descending colon',
    'Primary_site_Transverse colon',
    'Resection_type_Hemicolectomy or greater',
    'Resection_type_Total colectomy',
    'Resection_type_Colectomy plus removal of other organs',
    'Surg.Rad.Seq_Postoperative',
    'Surg.Rad.Seq_Preoperative',
    'Surg.Rad.Seq_Preoperative+Postoperative',
    'Surg.Rad.Seq_Sequence unknown',
    'Chemotherapy_Yes',
